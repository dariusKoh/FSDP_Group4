	...
	return (
		<div>
			...
			<form id="regForm" onSubmit={(e) => e.preventDefault()}>
				...
				<div className="flexBox">
					<label id="createUser" className="inputLabel padItem">
						Enter new Username
					</label>
					<input
						type="text"
					...
					/>
					<label className="inputLabel padItem">
						Enter backup email
					</label>
					<input
						type="email"
					...
					/>
					<label id="confirmLabel" className="inputLabel padItem">
						Confirm Password
					</label>
					<input
						type="password"
